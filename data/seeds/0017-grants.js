    ...
    return knex('grants').insert([
      {
        ...
        logo: `https://logo.clearbit.com/${modifiedUrl('http://www.bayareaglobalhealthchallenge.com/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '8/23/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('https://www.clintonfoundation.org/clinton-global-initiative/meetings/cgi-university/apply/before-you-apply')}?size=75`
      },
      {
        competition_name:
      ...
      },
      {
        ...
        has_requests: false,
        details_last_updated: '8/23/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('https://roddenberryprize.org/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '8/23/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('https://challenges.openideo.com/challenge/bridgebuilder/brief?utm_medium=email&utm_source=outreach&utm_campaign=bridge+ideas+briefjason')}?size=75`
      },
      {
        ...
        logo: `https://logo.clearbit.com/${modifiedUrl('http://westly.org/westly-prize/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '7/7/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('http://news.climatecolab.com/2017/06/2024/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '7/7/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('http://foodaccessproject.org/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '7/7/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('https://www.d-prize.org/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '7/7/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('https://thepollinationproject.org/about-us/')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '7/7/2017',
        logo: `https://logo.clearbit.com/${modifiedUrl('http://glgsocialimpact.com/fellows/')}?size=75`
      },
      {
        ...
        logo: `https://logo.clearbit.com/${modifiedUrl('http://www.natgeochasinggenius.com/')}?size=75`
      },
      {
        ...
        logo: `https://logo.clearbit.com/${modifiedUrl('https://startupinresidence.org/search/')}?size=75`
      },
      {
        ...
        logo: `https://logo.clearbit.com/${modifiedUrl('https://challenge.biomimicry.org/')}?size=75`
      },
      {
        ...
        logo: `https://logo.clearbit.com/${modifiedUrl('http://www.oxfordglobalchallenge.com')}?size=75`
      },
      {
        ...
        has_requests: false,
        details_last_updated: '2/13/2019',
        logo: `https://logo.clearbit.com/${modifiedUrl('https://socialbusinesscreation.hec.ca/')}?size=75`
      },
    ]);
  });
};
